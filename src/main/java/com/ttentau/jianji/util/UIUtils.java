...
import com.ttentau.jianji.global.App;
...
public class UIUtils {
	...
	public static Point getWidthAndHeight(Activity activity){
	...
	public static Point getWidthAndHeight(Context contextt){
	...
	public static void Toast(String value){
		if (t==null){
            t=Toast.makeText(getContext(),value,Toast.LENGTH_SHORT);
        }else {
		    t.setText(value);
        }
        t.show();
